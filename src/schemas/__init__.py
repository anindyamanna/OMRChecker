...
from OMRChecker.src.schemas.config_schema import CONFIG_SCHEMA
from OMRChecker.src.schemas.evaluation_schema import EVALUATION_SCHEMA
from OMRChecker.src.schemas.template_schema import TEMPLATE_SCHEMA
